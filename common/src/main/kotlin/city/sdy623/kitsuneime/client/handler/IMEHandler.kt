...
import city.sdy623.kitsuneime.client.handler.KeyHandler.CombinationKeyState.CombinationKeyAction.*
...
object IMEHandler {
    private val LOGGER = LogManager.getFormatterLogger(KitsuneIMEClient.MODNAME + "|IMEHandler")!!
