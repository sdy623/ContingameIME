...
#include "city_sdy623_kitsuneime_client_jni_ExternalBaseIME.h"
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* jvm, void* reserved) {
    ...
    jclass cls = env->FindClass("city/sdy623/kitsuneime/client/jni/ExternalBaseIME");
    if (cls == nullptr) {
        return -1;
    }

    JNINativeMethod methods[] = {
        {"nInitialize", "(J)V", (void*)Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nInitialize},
        {"nUninitialize", "()V", (void*)Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nUninitialize},
        {"nSetState", "(Z)V", (void*)Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nSetState},
        {"nSetFullScreen", "(Z)V", (void*)Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nSetFullScreen},
        {"nSetPreEditRect", "([I)V", (void*)Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nSetPreEditRect}
    };
...
{
    Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nUninitialize(NULL, NULL);
}
template<typename F>
...
JNIEXPORT void JNICALL Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nInitialize(JNIEnv* env, jobject obj, jlong hwnd)
{
    ...
    auto clStateName = "city/sdy623/kitsuneime/client/jni/ExternalBaseIME$CompositionState";
    auto clStateType = "Lcity/sdy623/kitsuneime/client/jni/ExternalBaseIME$CompositionState;";
    ...
    gmtd_onComposition = env->GetMethodID(clBaseIME, "onComposition", "(Ljava/lang/String;ILcity/sdy623/kitsuneime/client/jni/ExternalBaseIME$CompositionState;)V");
...
JNIEXPORT void JNICALL Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nUninitialize(JNIEnv* env, jobject)
{
    if (api) {
        delete api;
        api = nullptr;
...
JNIEXPORT void JNICALL Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nSetState(JNIEnv*, jobject, jboolean state)
{
    dbg_out("nSetState(%d) api=%p", (int)state, api);
    if (api) api->setActivated(state);
}

JNIEXPORT void JNICALL Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nSetFullScreen(JNIEnv*, jobject, jboolean fullscreen)
{
...
JNIEXPORT void JNICALL Java_city_sdy623_ingameime_client_jni_ExternalBaseIME_nSetPreEditRect(JNIEnv* env, jobject, jintArray rect)
{
    if (!api) return;
    jint buf[4] = {0,0,0,0};
