...
object ConfigHandler {
    ...
    var candidateHighlightColor = 0xFF_C9_DD_FF.toInt()
        set(value) {
            field = value
    ...
    fun loadDefaultConfig() {
        ...
        candidateHighlightColor = 0xFF_C9_DD_FF.toInt()
    }
    ...
    fun createConfigScreen(): ConfigBuilder {
        return ConfigBuilder.create()
            ...
            .setSavingRunnable { saveConfig() }.apply {
                ...
                getOrCreateCategory(Component.literal(I18n.get("config.ingameime.category.overlay"))).apply {
                    addEntry(
                        entryBuilder()
                            .startColorField(
                                Component.literal(I18n.get("desc.ingameime.candidateHighlightColor")),
                                candidateHighlightColor
                            )
                            .setDefaultValue(0xFF_C9_DD_FF.toInt())
                            .setTooltip(Component.literal(I18n.get("tooltip.ingameime.candidateHighlightColor")))
                            .setAlphaMode(true)
                            .setSaveConsumer { result ->
    ...
    private fun parseColor(text: String?): Int {
        ...
        if (raw.isNullOrEmpty()) return 0xFF_C9_DD_FF.toInt()
        val hex = if (raw.length == 6) "FF$raw" else raw
        return hex.toLongOrNull(16)?.toInt() ?: 0xFF_C9_DD_FF.toInt()
    }
