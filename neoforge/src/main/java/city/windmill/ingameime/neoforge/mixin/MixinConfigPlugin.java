...
public class MixinConfigPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        ...
        if (modList == null) {
            ...
            if (mixinClassName.equals("city.windmill.ingameime.neoforge.mixin.MixinTextFieldWidget")) {
                return false; // Skip REI mixin if we can't check yet
            }
            return true;
        }

        if (mixinClassName.equals("city.windmill.ingameime.neoforge.mixin.MixinFullScreen")) {
